...
sys.path.insert(0,"D:\SwamynathanLab\TensorflowCellSeperationExperiments\src")

import image_processing as IP
import utils as U

def get_conservative_cell_mask(image):
    """Adapted from D:\SwamynathanLab\TensorflowCellSeperationExperiments\src\cell_count_retinal_mapping\mapping.py"""
